...
feature {NONE}
	...
	tcc_delete (context: POINTER)
		require
			not_void_context_pointer: context /= Void
		external
			"C signature (TCCState *) use <libtcc.h>"
	end

	tcc_enable_debug (context: POINTER)
		require
			not_void_context_pointer: context /= Void
		external
			"C signature (TCCState *) use <libtcc.h>"
	...
	tcc_set_warning(context: POINTER; warning_name: STRING; value: INTEGER) : INTEGER
		require
			not_void_context_pointer: context /= Void
		external
...
feature {NONE}
	...
	tcc_add_include_path (context: POINTER; pathname: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
	...
	tcc_add_include_sysinclude_path (context: POINTER; pathname: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
	...
	tcc_define_symbol (context: POINTER; symbol: STRING; value: STRING)
		require
			not_void_context_pointer: context /= Void
	...
	tcc_undefine_symbol (context: POINTER; symbol: STRING)
		require
			not_void_context_pointer: context /= Void
			a_valid_symbol: symbol /= Void
			a_not_empty_symbol: not symbol.is_empty
...
feature {NONE}
	...
	tcc_add_file (context: POINTER; filename: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
	...
	tcc_compile_string (context: POINTER; content: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
...
feature {NONE}
	...
	tcc_set_output_type (context: POINTER; output_type: INTEGER) : INTEGER
		require
			not_void_context_pointer: context /= Void
	...
	tcc_add_library_path(context: POINTER; pathname: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
			a_valid_pathname: file_system.is_valid_directory(pathname)
		external
	...
	tcc_add_library(context: POINTER; libraryname: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
	...
	tcc_output_file(context: POINTER; filename: STRING) : INTEGER
		require
			not_void_context_pointer: context /= Void
			a_valid_filename: file_system.is_valid_filename (filename)
		external
	...
	tcc_set_lib_path(context: POINTER; path: STRING)
		require
			not_void_context_pointer: context /= Void
